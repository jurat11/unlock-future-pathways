...
app.listen(PORT, () => {
  ...
  console.log('');
  console.log('📋 To configure SMTP, add these to your .env file:');
  console.log('   VITE_SMTP_PROVIDER=gmail (or outlook, yahoo, custom)');
  console.log('   VITE_SMTP_USERNAME=your.email@gmail.com');
  console.log('   VITE_SMTP_PASSWORD=your_password_or_app_password');
  console.log('   VITE_SMTP_FROM_NAME=UNLOCK Admissions');
  console.log('');
});